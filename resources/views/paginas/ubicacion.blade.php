...
<html lang="es" data-bs-theme="auto">
  <head>
    ...
    <title>Ubicación - Click y Compra</title>
    ...
    <div class="container py-3">
      <header>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
          <h1 class="display-4 fw-normal text-body-emphasis">Ubicación</h1>
        </div>
      </header>
      ...
      <main>
        <div class="container py-5">
          ...
          <p class="lead text-center mb-4">
            Encuéntranos en la sede principal del ITFIP en El Espinal:
          </p>

          <div class="text-center mb-4">
            <h5>Instituto Tolimense de Formación Técnica Profesional – ITFIP</h5>
            <p>Calle 18 # 1ª-Carrera 1ª, Barrio Arkabal, El Espinal, Tolima, Colombia</p>
          </div>

          <!-- Se toma la dirección desde google maps y se inserta en un src para poder mostrar la ubicacion exacta -->
          <div class="d-flex justify-content-center">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15841.234567!2d-74.89822!3d4.15578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2sco!4v169xxx"
              width="100%"
              height="400"
